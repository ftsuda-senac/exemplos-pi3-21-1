...
<html>
    ...
    <body>
        <h1>Exemplo Formulario COM VALIDAÇÃO</h1>
        <form action="${pageContext.request.contextPath}/formulario-salvar" method="post">
            <input type="hidden" name="id" value="${dados.id}" />
            <div>
                <label>Nome</label>
                <input type="text" name="nome" placeholder="Preencha o nome completo" value="${dados.nome}" required maxlength="100" />
            ...
            <div>
                <label>Altura</label>
                <input type="number" name="altura" step="0.01" value="${dados.altura}" min="0" max="3" />
            ...
            <div>
                <label>Peso</label>
                <input type="number" name="peso" step="0.1" value="${dados.peso}" min="0" max="500" />
            ...
            <fieldset>
                ...
                <div>
                    <input type="radio" name="genero" value="0" id="generoF" ${dados.genero != 1 ? "checked" : ''} />
            ...
            <fieldset>
                ...
                <c:forEach items="${interesses}" var="interesse">
                    <div>
                        <input type="checkbox" name="interesses" value="${interesse}" id="interesse${interesse}" ${dados.interesses.contains(interesse) ? "checked" : ''} />
